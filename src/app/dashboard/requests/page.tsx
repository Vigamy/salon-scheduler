...
export default function RequestsPage() {
  return (
    <div className="flex flex-col gap-6">
      <h1 className="text-2xl font-bold font-headline tracking-tight">Solicitações de Agendamento</h1>
          ...
          <Card key={request.id} className="overflow-hidden">
            <CardHeader className="flex flex-row items-start gap-4 space-y-0 bg-muted/50 p-4">
              ...
              <div className="grid gap-1">
                ...
                <CardDescription>Nova solicitação de agendamento para <Badge variant="secondary">{request.service}</Badge></CardDescription>
              </div>
            </CardHeader>
            <CardContent className="p-4 grid md:grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="space-y-2">
                  <h3 className="font-semibold">Horário Preferido</h3>
